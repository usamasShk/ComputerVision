...
Dataset: Download the HAM10000 dataset from Kaggle or the official ISIC archive and place the images in a /data directory.

Execution: Open the .ipynb notebooks in Jupyter or Google Colab to run the training pipeline.
